...
const notes = [
  {
    ...
    preview: "Toxic effect of unsp substance, accidental, init",
  ...
  },
  {
    ...
    preview: "Poisoning by cocaine, assault, initial encounter",
  ...
  },
  {
    ...
    preview: "Strain of musc/fasc/tend at wrs/hnd lv, left hand, sequela",

    description:
      "Strain of other specified muscles, fascia and tendons at wrist and hand level, left hand, sequela",
  ...
  },
  {
    ...
    preview: "Pregnancy with inconclusive fetal viability, fetus 3",
  ...
  },
  {
    ...
    preview: "Supervision of elderly primigravida and multigravida",
  ...
  },
  {
    ...
    description:
      "Toxic effect of venom of other snake, accidental (unintentional), sequela",
  ...
  },
  {
    ...
    preview: "Other dystrophies primarily involving the sensory retina",
  ...
  },
  {
    ...
    preview: "Bitten by other hoof stock",
  ...
  },
  {
    ...
    preview: "Burn of third degree of unspecified thigh, sequela",

    description: "Burn of third degree of unspecified thigh, sequela",
  ...
  },
  {
    ...
    title: "Bliss (Mutluluk)",

    preview: "Congenital diverticulum of bladder",
  ...
  },
  {
    ...
    preview: "Occlusion and stenosis of bilateral carotid arteries",
  ...
  },
  {
    ...
    preview: "Other contact with crocodile, sequela",
  ...
  },
  {
    ...
    preview: "Other calcification of muscle, left upper arm",
...
const createList = ({ title, date, preview, isPopular }) => {
 return `<div class="showList">
    <span class="title">${title}</span>
    <span class="date">${date}</span>
    <span class="preview">${preview}</span>
    ${isPopular ? '<span class="popular">Popular</span>' : ""}
...
const createPopup = ({ title, date, description }) => {
  ...
  popup.innerHTML = `<div class="popupContent">
    ...
    <span class="showDescription">${description}</span>
</div>`;
  return popup;
...
const showPopup = (data) => {
    ...
    body.append(popup);
    body.querySelector(".popupClose").onclick = () => {
        popup.remove();
    }
  }
...
const render = () => {
  const notesItems = notes.map((items) => {

    const notesItem = document.createElement("div");

    notesItem.className = "item";

    notesItem.innerHTML = createList(items);

    const btn = notesItem.querySelector(".more");
